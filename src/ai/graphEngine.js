...
class GraphEngine {
    ...
    _seedKnownThreats() {
        ...
        seeds.forEach((s, i) => {
            const id = `seed-w${i + 1}`;
            this.addNode(id, s.domain, 'website', s.risk, { category: s.category, seeded: true });
        ...
        this.addNode('seed-ct1', '@lucky_support_bot', 'contact', 35);

        const edgeDefs = [
            ['seed-w1', 'seed-ip1', 'hosted on'], ['seed-w2', 'seed-ip1', 'hosted on'], ['seed-w4', 'seed-ip1', 'hosted on'],
            ['seed-w3', 'seed-ip2', 'hosted on'], ['seed-w5', 'seed-ip2', 'hosted on'],
            ['seed-w1', 'seed-t1', 'uses tracker'], ['seed-w2', 'seed-t1', 'uses tracker'], ['seed-w4', 'seed-t1', 'uses tracker'],
            ['seed-w1', 'seed-t2', 'uses pixel'], ['seed-w3', 'seed-t2', 'uses pixel'],
            ['seed-w1', 'seed-c1', 'shares cert'], ['seed-w2', 'seed-c1', 'shares cert'],
            ['seed-w3', 'seed-c2', 'shares cert'], ['seed-w5', 'seed-c2', 'shares cert'],
            ['seed-w1', 'seed-p1', 'uses wallet'], ['seed-w4', 'seed-p1', 'uses wallet'],
            ['seed-w1', 'seed-ct1', 'same operator'], ['seed-w2', 'seed-ct1', 'same operator'], ['seed-w5', 'seed-ct1', 'same operator'],
        ];
        edgeDefs.forEach(([s, t, l]) => this.addEdge(s, t, l));

        ['seed-w1', 'seed-w2', 'seed-w3', 'seed-w4', 'seed-w5'].forEach(id => this.clusters.set(id, 'CLS-0042'));
        ['seed-w6', 'seed-w7', 'seed-w10'].forEach(id => this.clusters.set(id, 'CLS-0038'));
    }
